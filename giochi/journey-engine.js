/* ============================================================
   JOURNEY ENGINE condiviso — usato da:
   · Il Grande Viaggio        (DUNGEON_DATA.id = "viaggio")
   · Il Sentiero dell'Iniziazione (id = "sentiero")
   · I Sette Piani            (id = "dng")
   Prima erano tre copie identiche (vgg/snt/dng-engine.js).
   Legge DUNGEON_DATA e DNG_I18N da window; l'id determina le
   chiavi localStorage (sc-<id>-state / sc-<id>-sigillo), che
   restano identiche a prima: i salvataggi sono preservati.
   Richiede game-core.js caricato prima.
   ============================================================ */
(function(){
"use strict";
