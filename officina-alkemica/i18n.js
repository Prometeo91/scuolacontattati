...
(function () {
  ...
  const STR = {
    ...
    mode_fasi_t: { it: "Le Tre Fasi dell'Opera", en: "The Three Phases of the Work" },
    mode_fasi_d: { it: "Attraversa Nigredo, Albedo e Rubedo: dal Piombo all'Oro.", en: "Cross Nigredo, Albedo and Rubedo: from Lead to Gold." },
    ...
    fasiNote: { it: "L'Opera procede per gradi: ogni risposta esatta avanza la trasmutazione.", en: "The Work proceeds by degrees: each correct answer advances the transmutation." },
