/* IL GRANDE VIAGGIO — journey engine (clone del dungeon engine) */
(function(){
"use strict";
const D=window.DUNGEON_DATA, I=window.DNG_I18N;
const LS_KEY="sc-viaggio-state",LS_LANG="sc-lang",LS_THEME="sctheme";
...
function renderEnding(){
  ...
  if(isGameOver){
    ...
    try{localStorage.setItem("sc-viaggio-sigillo",String(Date.now()));}catch(e){}
