/* I SETTE PIANI — dungeon engine */
(function(){
"use strict";
const D=window.DUNGEON_DATA, I=window.DNG_I18N;
const LS_KEY="sc-dng-state",LS_LANG="sc-lang",LS_THEME="sctheme";
...
function renderPlaneIntro(){
  ...
  n.appendChild(frag(`<div class="rpg-act-numeral" style="color:${p.color}">⟐ ${esc(t("plane"))} ${S.plane+1}/7 ⟐</div>`));
